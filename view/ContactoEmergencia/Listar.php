...
<body onload="messageInfo();">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <h2 class="page-title">Contactos de emergencia</h2>
                <div class="row">
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped" id="t-usuarios" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <?php
                        $listado = listadoContactoEmergenciaId($id_tbl_empleados);
                        if ($listado) {
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-light" data-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu" <?php if(pg_num_rows($listado) == 1){echo 'style="height: 130%; overflow: auto;"';}?>>
                                                        <a class="dropdown-item"
                                                        href="<?php echo "Editar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_ctrl_contacto_emergencia).'&D-F3='.$id_tbl_control_plazas.'&RP='.$id_tbl_centro_trabajo ?>">Modificar</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" data-toggle="modal" data-target="<?php echo '#modal-'.$obj->id_ctrl_contacto_emergencia?>">Eliminar</a>
                                                </div>
                                            </div>

                                            <!-- MODAL ELIMINAR -->
                                            <div class="modal fade" id="<?php echo 'modal-'.$obj->id_ctrl_contacto_emergencia?>" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo "../../php/ControlContactoEmergenciaC/Eliminar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_ctrl_contacto_emergencia).'&D-F3='.$id_tbl_control_plazas.'&RP='.$id_tbl_centro_trabajo ?>">Confirmar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
