...
<body>
    ...
    <?php include ("../../php/ZonasPagoC/Listar.php") //Se incluye la libreria para generar su tabla   ?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h2 class="page-title">Zonas de Pago</h2>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Zonas de Pago</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class=" btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="../CentroTrabajo/Listar.php">Regresar</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class=" btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="<?php echo "Editar.php?D-F=" . base64_encode($id_tbl_centro_trabajo) . "&D-F2=" . base64_encode($obj->id_tbl_zonas_pago) ?>">Modificar</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" data-toggle="modal"
                                                        data-target="<?php echo '#modal-' . $obj->id_tbl_zonas_pago ?>">Eliminar</a>
                                                </div>
                                            </div>

                                            <!-- MODAL ELIMINAR -->
                                            <div class="modal fade" id="<?php echo 'modal-' . $obj->id_tbl_zonas_pago ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-light"
                                                                ...
                                                                href="<?php echo "../../php/ZonasPagoC/Eliminar.php?D-F=" . base64_encode($id_tbl_centro_trabajo) . "&D-F2=$" . base64_encode($obj->id_tbl_zonas_pago) ?>">Confirmar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <?php
                                            echo catPk($obj->id_cat_unidad_responsable);
                                            ?>
                                        </td>
                                    </tr>
                                    <?php
