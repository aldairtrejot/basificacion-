            ...
            <div class="container-fluid">
                ...
                <div class=" btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item"
                            href="<?php echo '../Empleados/Listar.php?D-F3=' . $id_tbl_control_plazas . '&D-F3=' . $id_tbl_control_plazas.'&RP='.$id_tbl_centro_trabajo ?>">Regresar</a>
                    </div>
                </div>
                                        ...
                                        <td>
                                            ...
                                            <div class=" btn-group">
                                                ...
                                                <div class="dropdown-menu" <?php if(pg_num_rows($listado) == 1){echo 'style="height: 130%; overflow: auto;"';}?>>
                                                    <a class="dropdown-item"
                                                        href="<?php echo "Editar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_ctrl_medios_contacto) . '&D-F3=' . $id_tbl_control_plazas .'&RP='.$id_tbl_centro_trabajo?>">Modificar</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" data-toggle="modal"
                                                        data-target="<?php echo '#modal-' . $obj->id_ctrl_medios_contacto ?>">Eliminar</a>
                                                </div>
                                            </div>

                                            <!-- MODAL ELIMINAR -->
                                            <div class="modal fade" id="<?php echo 'modal-' . $obj->id_ctrl_medios_contacto ?>"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-light" style="background-color: #cb9f52; border:none; outline:none; color: white;"
                                                                href="<?php echo "../../php/ControlMediosContactoC/Eliminar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_ctrl_medios_contacto) . '&D-F3=' . $id_tbl_control_plazas.'&RP='.$id_tbl_centro_trabajo ?>">Confirmar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
