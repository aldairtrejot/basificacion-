            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h2 class="page-title">Agregar Registro Patronal</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../../php/RegistroPatronalC/Agregar.php">
                            <div class="form-row">
                            <input type="hidden" id="id_tbl_centro_trabajo" name="id_tbl_centro_trabajo" value="<?php echo $id_tbl_centro_trabajo?>" />
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                        id="registro_patronal" name="registro_patronal" placeholder="Registro Patronal">
                                </div>
