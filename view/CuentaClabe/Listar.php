...
<body onload="messageInfo();">
    ...
    <?php include ('../../php/ControlCuentaClabeC/Listar.php');?>
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped" id="t-usuarios" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <?php
                        $listado = listadoCuentaClabeId($id_tbl_empleados);
                        if ($listado) {
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-light" data-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu" <?php if(pg_num_rows($listado) == 1){echo 'style="height: 130%; overflow: auto;"';}?>>
                                                    ...
                                                    <a class="dropdown-item" data-toggle="modal" data-target="<?php echo '#modal-'.$obj->id_ctrl_cuenta_clabe?>">Eliminar</a>
                                                </div>
                                            </div>

                                            <!-- MODAL ELIMINAR -->
                                            <div class="modal fade" id="<?php echo 'modal-'.$obj->id_ctrl_cuenta_clabe?>" tabindex="-1" role="dialog"
