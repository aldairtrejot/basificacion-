            ...
            '<tbody>
                        <tr>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <button onclick="asitenciaEmpleado(' . $row['id_tbl_empleados_hraes'] . ')" class="dropdown-item btn btn-light"><i class="fa fa-star icon-delete-table"></i> Asistencia</button> 
