...
class ModelRetardoM
{
    function listarById($id_object, $paginator)
    {
        $listado = pg_query("SELECT 
                            ...
                            LEFT JOIN cat_estatus_bas
                            ON ctrl_asistencia_bas.id_cat_estatus_bas = 
                                cat_estatus_bas.id_cat_estatus_bas
    ...
    function listarByBusqueda($id_object, $busqueda, $paginator)
    {
        $listado = pg_query("SELECT 
                            ...
                            AND ( fecha::date::TEXT LIKE '%$busqueda%'
                                ...
                                OR UPPER(cat_estatus_bas.nombre) LIKE '%$busqueda%'
                                )
                            ORDER BY id_ctrl_asistencia_bas DESC
                            LIMIT 3 OFFSET $paginator;");
        return $listado;
