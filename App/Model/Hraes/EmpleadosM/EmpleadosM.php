...
class modelEmpleadosHraes
{
    ...
    public function fomopeQueryAll($name){
        $query = pg_query("INSERT INTO $name (
                                no_,
                                fecha_expedicion,
                                apellido_paterno,
                                apellido_materno,
                                ...
                                estado_nacimiento,
                                edad,
                                fecha_ingreso_gobierno_fed,
                                fecha_ingreso_imss_bienestar,
                                codigo_puesto,
                                nivel,
                                nombre_puesto,
                                especialidaad,
                            ...
                            SELECT A.id_tbl_empleados_hraes AS no_,
                                            ...
                                            TRIM(CC.carrera) AS descripcion, 
                                            CONCAT (UPPER(BB.nivel_estudios), ' EN ', TRIM(CC.carrera)) as carreras_x,
